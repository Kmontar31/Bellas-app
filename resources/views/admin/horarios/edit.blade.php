        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-header bg-warning text-dark">
                    <h5 class="mb-0">
                        <i class="fas fa-edit"></i> Editar Horario de Disponibilidad
                    </h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.horarios.update', $horario->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            >
                                ...
                                @foreach($profesionales as $prof)
                                    <option value="{{ $prof->id }}" @selected(old('profesional_id', $horario->profesional_id) == $prof->id)>
                                        {{ $prof->nombre }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            >
                                ...
                                <option value="0" @selected(old('dia_semana', $horario->dia_semana) == 0)>Domingo</option>
                                <option value="1" @selected(old('dia_semana', $horario->dia_semana) == 1)>Lunes</option>
                                <option value="2" @selected(old('dia_semana', $horario->dia_semana) == 2)>Martes</option>
                                <option value="3" @selected(old('dia_semana', $horario->dia_semana) == 3)>Miércoles</option>
                                <option value="4" @selected(old('dia_semana', $horario->dia_semana) == 4)>Jueves</option>
                                <option value="5" @selected(old('dia_semana', $horario->dia_semana) == 5)>Viernes</option>
                                <option value="6" @selected(old('dia_semana', $horario->dia_semana) == 6)>Sábado</option>
                            </select>
                            @error('dia_semana')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
