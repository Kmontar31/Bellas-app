...
<div class="row">
    ...
    <form method="POST" class="" action="{{ route('admin.profesionales.store') }}">
    @csrf
    {{-- Campo Nombre --}}
    <div class="row mb-3">
    ...
    {{-- Campo Telefono--}}
    <div class="row mb-3">
        <label for="telefono" class="col-md-2 col-form-label text-md-end">{{('Teléfono') }}</label>
        <div class="col-md-6">
    ...
    {{-- Especialidad--}}
    <div class="row mb-3">
        <label for="especialidad" class="col-md-2 col-form-label text-md-end">{{('Especialidad') }}</label>
        <div class="col-md-6">
    ...
    <div class="row mb-0">
        <div class="col-md-6 offset-md-4">
            ...
            <a href="{{ route('admin.profesionales.index') }}" class="btn btn-secondary">Cancelar</a>
        </div>
    </div>
</form>
</div>
