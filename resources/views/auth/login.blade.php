...
<head>
  ...
  <title>Sitema de reserva de citas</title>
...
<body class="hold-transition login-page"
        style="background-image:url('{{url('assets/img/hero-bg.jpg')}}'); background-repeat: no-repeat; 
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="" class="h1"><b>Bellas-Spa</a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Inicia  de Sesión</p>
